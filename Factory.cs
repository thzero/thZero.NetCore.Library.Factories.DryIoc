...
namespace thZero
{
	public class FactoryDryIoc : Factory
	{
		...
		{
			TProviderType obj = (TProviderType)Activator.CreateInstance<TInstanceType>();
			if (string.IsNullOrEmpty(named))
		...
		private static readonly object LockKernel = new object();
		#endregion
	}
}